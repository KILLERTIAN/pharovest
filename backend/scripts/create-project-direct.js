...
const projectId = process.argv[3] ? parseInt(process.argv[3], 10) : null;
...
async function main() {
  try {
    ...
    if (!privateKey) {
      ...
      console.log("Example: node create-project-direct.js YOUR_PRIVATE_KEY 4");
      process.exit(1);
    }
    
    if (projectId === null) {
      console.error("Please provide a project ID as the second argument");
      console.log("Example: node create-project-direct.js YOUR_PRIVATE_KEY 4");
    ...
    console.log(`Your new project has blockchain ID: ${newProjectCount - 1n}`);
