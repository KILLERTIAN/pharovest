                ...
                <div className="flex flex-col items-center justify-center bg-white relative min-h-[500px] lg:min-h-screen w-full p-8">
                    ...
                    <Link to="/" className="absolute top-0 left-0 flex flex-row items-center justify-center cursor-pointer p-5 z-[999]">
                        <FadeIn direction="right" delay={0.3}>
                            <img className="md:h-[50px] h-[30px] md:pr-2" src="https://res.cloudinary.com/djoebsejh/image/upload/v1746277693/Pharos/b4l4e8yqnyde0p4tbs6r.png" alt="Logo" />
                            <h1 className="md:text-4xl text-3xl font-semibold text-[#1B7A57] cursor-pointer">Pharovest</h1>
                        </FadeIn>
                    </Link>
